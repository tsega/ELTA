...
<section id="slide-2" class="parallax">
  ...
  <div class="hsContainer">
    <div class="hsContent clearfix"
    data-center="opacity: 1"
    data-106-top="opacity: 0">
    <div class="transparent-bg clearfix">
      <div class="col-md-6">
...
<section id="slide-3" class="parallax">
  ...
  <div class="hsContainer">
    ...
    data-center="opacity: 1"
    data-106-top="opacity: 0">
    <?php print render($page['parallax_section_5']); ?>
  </div>
</div>
</div>
</section>
...
<section id="slide-4" class="parallax">
  ...
  <div class="hsContainer">
    <div class="hsContent"
    data-top-top="top: 150px;">
    <?php print render($page['parallax_section_6']); ?>
  </div>
</div>
</div>
</section>
